      ...
      <div className="container relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div className="max-w-2xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#ffefce]/20 bg-[#fff8e9]/10 px-3 py-1.5 text-xs font-bold text-[#ffdf92]">
            ...
            Atendimento rápido · retirada ou entrega
          </div>
          ...
          <p className="mb-3 text-xs font-extrabold uppercase tracking-[0.19em] text-[#d9e19b]">Marmita do dia</p>
          <h1 className="font-display max-w-xl text-5xl leading-[0.96] tracking-[-0.045em] text-[#fff8e9] sm:text-6xl lg:text-7xl">
            Marmita do dia, <span className="text-[#ffc94f]">pronta para o seu pedido.</span>
          </h1>
          <p className="mt-5 max-w-lg text-base leading-relaxed text-[#fff8e9]/74 sm:text-lg">
            Escolha a marmita de hoje, personalize e receba no seu ritmo. Sabor de comida feita com carinho, sem complicação.
          </p>
          <div className="mt-7 flex flex-wrap gap-3">
            <a href="#cardapio" className="inline-flex items-center gap-2 rounded-full bg-[#ffc94f] px-5 py-3.5 text-sm font-extrabold text-[#481e1f] shadow-[0_12px_24px_rgba(0,0,0,0.18)] transition duration-200 hover:bg-[#ffdc77] active:scale-[0.97]">
              Realizar pedido <ArrowDown className="size-4" />
            </a>
            <a href="#cardapio" className="inline-flex items-center gap-2 rounded-full border border-[#fff8e9]/22 px-5 py-3.5 text-sm font-bold text-[#fff8e9] transition hover:bg-[#fff8e9]/10">
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-none">
          ...
          <div className="relative rotate-[-2deg] rounded-[2rem] border border-[#fff3d4]/15 bg-gradient-to-br from-[#f9d77e] via-[#d9933d] to-[#92411e] p-3 shadow-[0_26px_70px_rgba(0,0,0,0.33)]">
            <div className="rounded-[1.55rem] border border-[#6c2d1f]/15 bg-[#ffecc2] p-4 text-[#481e1f]">
              <div className="flex items-center justify-between text-xs font-black uppercase tracking-[0.14em] text-[#9c4d28]"><span>Marmita do dia</span><span>feito com carinho</span></div>
              <div className="mt-4 grid grid-cols-[1.2fr_0.8fr] gap-3">
                <div className="relative min-h-43 overflow-hidden rounded-3xl bg-[#ad4d27] shadow-inner">
                  ...
                  <p className="absolute inset-x-5 bottom-5 font-display text-2xl leading-none text-[#fff8e9]">Carne de panela<br />com purê.</p>
                </div>
              ...
              <div className="mt-4 rounded-2xl bg-[#fffaf1]/65 px-4 py-3 text-sm font-semibold text-[#664b3d]">Escolha, personalize e peça pelo cardápio.</div>
            </div>
          </div>
        </div>
      </div>
