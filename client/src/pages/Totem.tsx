  ...
  return (
    <main className="min-h-dvh bg-[#fff7ea] text-[#481e1f] touch-manipulation">
      ...
      <section className="mx-auto flex min-h-[calc(100dvh-81px)] max-w-xl flex-col px-5 pb-7 pt-6">
        ...
        {state.step === "products" && <ProductStep title="Escolha sua marmita" products={products.filter((product) => product.categoryId === categoryId)} items={state.items} onAdd={add} onUpdate={update} />}
